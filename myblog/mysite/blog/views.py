...
from models import Entry, Category, Post 
...
def home(request):
   ...
   return render_to_response('home.html', {'posts': result['entries'], 'dates' : result['dates'], })
...
def view_category(request, slug):
    ...
    return render_to_response('view_category.html', {'category': category, 'posts': Entry.objects.filter(category=category)[:5]}k)
