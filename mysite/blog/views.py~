...
def view_month(request, year, month):
    ...
    return render_to_response('view_month.html', {
    	'posts': entry,
        'month' : month_display,
        'year' : year,
    })
...
def view_citations(request):
    ...
    return render_to_response('view_citation.html', {
        'quotes': quotes,
        'posts': result['entries'][:5],
        'dates' : result['dates'],
    })
...
def get_base_content():
        monthDict={1:'Janvier', 2:'Février', 3:'Mars', 4:'Avril', 5:'Mai', 6:'Juin', 7:'Juillet', 8:'Août', 9:'Septembre', 10:'Octobre', 11:'Novembre', 12:'Décembre'}
        monthDictSansAcc={1:'janvier', 2:'fevrier', 3:'mars', 4:'avril', 5:'mai', 6:'juin', 7:'juillet', 8:'aout', 9:'septembre', 10:'octobre', 11:'novembre', 12:'decembre'}
        dates = []
